            ...
            <div>
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-4">
                            <Panel titulo="Panel title" texto="Some quick example text to build on the panel title and make up the bulk of the panel's content." />
                            Imagem de <a href="https://pixabay.com/pt/users/RitaE-19628/?utm_source=link-attribution&amp;utm_medium=referral&amp;utm_campaign=image&amp;utm_content=3406864">RitaE</a> por <a href="https://pixabay.com/pt/?utm_source=link-attribution&amp;utm_medium=referral&amp;utm_campaign=image&amp;utm_content=3406864">Pixabay</a>
                        </div>
                    </div>
                    ...
                    <Carousel id="carousel-component" imagens={[
                        ...
                        {url:'/carousel/paper-3406864_1280.jpg'}
                    ]} />
                </div>
            </div>
        );
